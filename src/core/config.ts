 ...
 * entry, never overwrites (an internal note, Section 4). Rejects loudly if the
 * identity is already claimed by a DIFFERENT workspace id -- a /review
 * finding: without this check, two workspace ids could silently share one
